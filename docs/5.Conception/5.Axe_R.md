...
La pièce d'accouplement (première pièce) : Fixée directement sur l'arbre du servomoteur, son rôle est de transmettre le couple mécanique du moteur et de servir d'interface de fixation robuste pour l'élément suivant.

La pièce de guidage pneumatique (seconde pièce) : Installée par-dessus la première, cette pièce spécifique est conçue pour maintenir fermement le tuyau de la pompe à vide, assurant ainsi que le flux d'air reste parfaitement aligné sans pincer ou emmêler le tube lors de la rotation.
